...
%   and it must be real and nonsparse. Note that any input image that
%   is not uint8 is first internally converted to uint8 before looking
%   for MSER regions.
%
...
%            detectMinEigenFeatures, detectSURFFeatures, detectORBFeatures,
%            SURFPoints
